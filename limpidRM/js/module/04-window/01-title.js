...
LIMScene_title_window.prototype.initNewgame=function (){
    Scene.snapForBackground(1)
}
LIMScene_title_window.prototype.condNewgame=function (){
    if(Scene.snapshot[1]) return true
}
...
LIMScene_title_window.prototype.endStart=function () {
    ...
    //记忆
    if(!Config.opmemory)
        this.OP_T({index:LIM.Cache["标题选项"]||(DataBase.isSave()?2:1),mute:true})
    else
...
LIMScene_title_window.prototype.reduction_OP=function (index,data) {
    ...
    if(index) this.grabBit("op"+index).clear()
}
/////////////////////////////////////////////////////////////
//按键
/////////////////////////////////////////////////////////////
LIMScene_title_window.prototype.Trigger_up_1=function (){
    this.Longkey_up_1()
    this.setNote("TU",performance.now())
}
LIMScene_title_window.prototype.Trigger_down_1=function (){
    this.Longkey_down_1()
