...
LIMScene_config_window.prototype.execute=function (){
    ...
    //记忆
    if(!Config.opmemory)
        this.OP_T({index:LIM.Cache["标题选项"]||1,mute:true})
    else
...
LIMScene_config_window.prototype.Trigger_up_1=function (){
    this.Longkey_up_1()
    this.setNote("TU",performance.now())
}
LIMScene_config_window.prototype.Trigger_down_1=function (){
    this.Longkey_down_1()
...
LIMScene_config_window.prototype.Trigger_left_1=function (){
    this.Longkey_left_1()
    this.setNote("TL",performance.now())
}
LIMScene_config_window.prototype.Trigger_right_1=function (){
    this.Longkey_right_1()
    this.setNote("TR",performance.now())
}
LIMScene_config_window.prototype.Longkey_left_1=function (){
    ...
    switch (index){
        ...
        case 3:
            ...
            break
        case 4:
            arr=Config.select.opmemory
            num=arr.indexOf(Config.opmemory)-1
            Config.opmemory=(arr[num<0?arr.length-1:num])
            Conductor.play("cursor",0)
            break
        case 5:
            ...
            if(Config.Volume) Conductor.play("cursor",0)
        ...
        case 6:
            ...
            if(Config.seVolume) Conductor.play("cursor",0)
            Tone.Master.mute = false
            break
        case 7:
...
LIMScene_config_window.prototype.Longkey_right_1=function (){
    ...
    switch (index){
        ...
        case 4:
            arr=Config.select.opmemory
            Config.opmemory=(arr[(arr.indexOf(Config.opmemory)+1)%arr.length])
            Conductor.play("cursor",0)
            break
        case 5:
            arr=Config.select.volume
...
LIMScene_config_window.prototype.drawLanguage=function (index) {
    ...
    this.setText("cont",this.getOpCont(index))
...
LIMScene_config_window.prototype.getOpVal=function (index){
    switch (index) {
        ...
        case 3:
            return Config.getText("文本速度_"+(Config.textspeed*100)+"%")
        case 4:
            return Config.getText("开关_"+(Config.opmemory))
        case 5:
